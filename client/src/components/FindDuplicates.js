...
const API_URL = 'https://contact-manager-backend-chi.vercel.app'
  async function fetchDuplicates(){
    ...
    // }
    try{
      const response = await axios.get(`https://cm-backend-service-8dc88f99d89b.herokuapp.com/api/contacts/handle-duplicates`);
      setProgress(100)
  ...
  async function deleteDuplicates(){
    ...
    try{
      const response = await axios.get(`https://cm-backend-service-8dc88f99d89b.herokuapp.com/api/contacts/handle-duplicates?delete=true`);
